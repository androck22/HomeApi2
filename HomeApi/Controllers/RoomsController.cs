...
namespace HomeApi.Controllers
{
    ...
    public class RoomsController : ControllerBase
    {
        ...
        /// <summary>
        /// Просмотр списка добавленных комнат
        /// </summary>
        [HttpGet]
        [Route("")]
            ...
            [FromBody] EditRoomRequest request)
        {
            ...
            return StatusCode(200, $"Информация по комнате обновлена! Название комнаты - {room.Name}, Площадь комнаты - {room.Area},  Газовое подключение - {room.GasConnected}, Вольтаж - {room.Voltage}");
        }
    }
}